...
export default class News extends Component {
  ...
  async updateNews(){
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=78ff19aa95f644c5ad71a395108b2797&page=${this.state.page}&pageSize=${this.props.pageSize}`;
